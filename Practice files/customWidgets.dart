...
class RandomScroll extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Expanded(
      flex: 15,
      child: Container(
        ...
        child: ListView.builder(itemBuilder: (context, index) {
          return Padding(
            ...
            child: Container(
              child: Center(child: Text("Pikachu", style: TextStyle(
                  fontSize: 30,
                  fontFamily: "bungee",
...
class BlankArea1 extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Expanded(
      flex: 25,
      child: Container(
        ...
        child: Center(child: Text("Piku", style: TextStyle(
            fontSize: 40,
            fontFamily: "bungee",
            fontWeight: FontWeight.bold),)),

      ),);}}
class BlankArea extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Expanded(
        flex: 25,
